...
void main(void) {
    ...
    */
    ...
    //i2c_master_recv(0x08, 0x01);
    /*
    unsigned char i2c_data[6] = {0x30, 0x31, 0x32, 0x33, 0x34, 0x35};
    unsigned char i2c_data_2[3] = {0x70, 0x71, 0x72};
    i2c_master_send(sizeof(i2c_data), i2c_data);
    i2c_master_send(sizeof(i2c_data_2), i2c_data_2);
    */
